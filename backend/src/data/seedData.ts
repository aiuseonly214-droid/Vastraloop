import { UserEntity, OutfitItemEntity, RentalOrderEntity, DamageClaimEntity, BoutiquePartnerEntity, PayoutRecord } from '../models/types';
import { hashPassword } from '../utils/crypto';

// Seed default password for demo accounts: "password123"
...
export const SEED_USERS: UserEntity[] = [
  {
    ...
    passwordHash: demoPasswordHash.hash,
    salt: demoPasswordHash.salt,
  ...
  },
  {
    id: 'user-owner-1',
    name: 'Sunil Deshmukh',
    phone: '+91 98231 55442',
    email: 'sunil@vastaboutique.in',
    passwordHash: demoPasswordHash.hash,
    salt: demoPasswordHash.salt,
    city: 'Nashik, Maharashtra',
    address: 'Shop 4, College Road, Near BYK College, Nashik - 422005',
    verifiedId: true,
    role: 'owner',
    createdAt: '2026-08-01T10:00:00.000Z',
    updatedAt: '2026-08-01T10:00:00.000Z',
  ...
  {
    id: 'user-admin-1',
    name: 'Vastraloop Operations Admin',
    phone: '+91 98220 18000',
    email: 'admin@vastraloop.in',
    passwordHash: demoPasswordHash.hash,
    salt: demoPasswordHash.salt,
    city: 'Nashik, Maharashtra',
    address: 'Vastraloop HQ, Canada Corner, Nashik - 422002',
    verifiedId: true,
    role: 'admin',
    createdAt: '2026-08-01T10:00:00.000Z',
    updatedAt: '2026-08-01T10:00:00.000Z',
...
export const SEED_BOUTIQUES: BoutiquePartnerEntity[] = [
  {
    id: 'boutique-1',
    ...
    address: 'Shop 4, College Road, Near BYK College, Nashik - 422005',
    phone: '+91 98231 55442',
    verificationType: 'GSTIN Verified (27AAAAA0000A1Z5)',
    isVerified: true,
    totalEarnings: 14850,
    bankAccountSummary: 'HDFC Bank Nashik Branch ••4491',
    ownerUserId: 'user-owner-1'
  },
  {
    id: 'boutique-2',
    name: 'Royal Nashik Tailors',
    location: 'Main Road, Nashik',
    address: 'Near Shalimar Chowk, Main Road, Nashik - 422001',
    phone: '+91 94222 88991',
    verificationType: 'Shop Act ID Verified',
    isVerified: true,
    totalEarnings: 9800,
    bankAccountSummary: 'ICICI Bank Main Road ••8812',
    ownerUserId: 'user-owner-1'
  },
  {
    id: 'boutique-3',
    name: 'Sabyasachi Inspired Boutique',
    location: 'Gangapur Road, Nashik',
    address: 'Opp. Big Bazaar, Gangapur Road, Nashik - 422013',
    phone: '+91 98901 77332',
    verificationType: 'Trade License Verified',
    isVerified: true,
    totalEarnings: 22400,
    bankAccountSummary: 'Axis Bank Gangapur ••3321',
    ownerUserId: 'user-owner-1'
  },
  {
    id: 'boutique-4',
    ...
    address: 'Shop 12, Mahatma Nagar Arcade, Nashik - 422007',
    phone: '+91 97654 33210',
    verificationType: 'GSTIN Verified',
    isVerified: true,
    totalEarnings: 11200,
    bankAccountSummary: 'SBI Mahatma Nagar ••1190',
    ownerUserId: 'user-owner-1'
  },
  {
    id: 'boutique-5',
    ...
    address: '1st Floor, Canada Corner, Sharanpur Road, Nashik - 422002',
    phone: '+91 98223 99001',
    verificationType: 'Handloom Silk Board Verified',
    isVerified: true,
    totalEarnings: 18500,
    bankAccountSummary: 'Bank of Maharashtra ••7734',
    ownerUserId: 'user-owner-1'
  }
];

export const SEED_OUTFITS: OutfitItemEntity[] = [
  {
    id: 'outfit-1',
  ...
  },
  {
    ...
    boutique: 'Sabyasachi Inspired Boutique',
...
export const SEED_ORDERS: RentalOrderEntity[] = [
  {
    id: 'order-1',
    orderNumber: '#VL-8821',
    ...
    outfitId: 'outfit-1',
    outfitTitle: 'Royal Navy Silk Sherwani',
...
export const SEED_CLAIMS: DamageClaimEntity[] = [
  {
    id: 'claim-101',
    orderNumber: '#VL-8610',
    orderId: 'order-sample-archived',
    itemTitle: 'Ivory Tuxedo Suit',
    reportedBy: 'Elite Menswear (Owner)',
    reportedById: 'user-owner-1',
    issueType: 'Stain',
    claimedAmount: 400,
    status: 'Approved',
    evidenceDescription: 'Small beverage stain on right cuff sleeve. Requires specialized dry cleaning.',
    resolutionNotes: 'Approved deduction of ₹400 for dry cleaning receipt.',
    adjustedAmount: 400,
    createdAt: '2026-08-18T14:30:00.000Z',
    resolvedAt: '2026-08-18T16:00:00.000Z'
  }
];
